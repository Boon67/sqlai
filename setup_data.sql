...
(1, 'Robert Chen', 'rchen@techstartup.com', 
 'We need to file a D&O claim. Our board made a decision on January 15, 2024 that resulted in shareholder litigation. Policy number: DO-2024-789456. The lawsuit alleges breach of fiduciary duty. Total claim amount estimated at $2.5M. Please expedite review.', 
 '2024-01-20', 'Claims'),
...
(3, 'Michael Thompson', 'mthompson@consultingfirm.com',
 'Requesting E&O coverage information for our consulting firm. We have 25 consultants and annual revenue of $5M. Need professional liability limits of $3M per claim and $5M aggregate. What are your premium rates? Policy effective date needed: March 1, 2024.',
...
(8, 'Lisa Chen', 'lchen@medtech.com',
 'Requesting quote for medical device E&O coverage. Annual revenue: $20M. Product: AI-powered diagnostic software. Need coverage for FDA compliance issues and product liability. Looking for $10M limits. Clinical trials phase completed. Risk assessment needed.',
...
(10, 'Patricia Lee', 'plee@boardmembers.com',
 'D&O policy inquiry for our board members. We are a public company, market cap $500M. Need Side A, B, and C coverage. Previous insurer non-renewed us. Looking for $25M in coverage. Any prior acts coverage available? Board size: 9 members. Need quote by end of month.',
...
(2, 'D&O Basic Policy', 'Very disappointed with claims handling. Took 6 weeks to assign defense counsel. Coverage exclusions were not clearly explained during sales process. Claim was partially denied due to obscure policy language. Would not renew.', 1, '2024-01-11'),
(3, 'E&O Professional Plus', 'Adequate coverage for small consulting firms. Premium is reasonable at $8K annually for $2M limits. Claims process is straightforward. However, policy has high deductible of $25K. Good value but not great for frequent small claims.', 3, '2024-01-12'),
...
(6, 'Professional Liability Tech', 'Decent E&O coverage for software companies. Pricing is competitive. Coverage includes IP infringement and data breach. Policy wording could be clearer on exclusions. Average experience overall but meets basic needs.', 3, '2024-01-15'),
(7, 'Directors Shield Gold', 'Exceptional D&O coverage! Side A, B, and C all included. Non-recourse advancement of defense costs. Claims team has deep expertise in securities litigation. Premium was higher but worth it for peace of mind. Our board loves this coverage!', 5, '2024-01-16'),
...
(10, 'Management Liability Package', 'Excellent bundled coverage! Includes D&O, EPLI, Fiduciary, and Crime. One premium, one deductible, streamlined claims. Saved 20% vs buying policies separately. Great for mid-size companies. Very satisfied with coverage and service.', 4, '2024-01-19');
...
(2, 'Votre police D&O a été renouvelée avec succès. Nouvelles limites: 10M€. La prime annuelle est de 85 000€. Les documents de police seront envoyés dans 48 heures.', 'fr', 'renewal_confirmation'),
...
(6, 'La sua polizza D&O per amministratori e dirigenti è stata sottoscritta. Copertura: 15M€. Include Side A, B e C. Servizio legale 24/7 disponibile per emergenze.', 'it', 'policy_confirmation'),
(7, '사이버 보안 사고가 보고되었습니다. 사고 대응팀이 즉시 배치됩니다. 보험 증권 번호: CYB-2024-8899. 24시간 핫라인으로 연락주세요.', 'ko', 'incident_alert'),
(8, 'Sua apólice de seguro E&O foi aprovada. Limite de cobertura: R$ 5 milhões. Franquia: R$ 50 mil. Vigência: 12 meses a partir de 01/03/2024.', 'pt', 'underwriting_approval'),
...
(3, 'E&O_Underwriting_Guidelines.txt',
...
(1, 'CFO_Network', 'Just renewed our D&O insurance. Premium increased 40% this year! Market is hardening significantly. Other CFOs seeing similar increases? #DirectorsAndOfficers #Insurance #CFO', 'LinkedIn', '2024-01-10 09:15:00'),
...
(3, 'Startup_Founder', 'Our E&O insurance claim was denied because of a technicality in the application. Read the fine print people! Now facing a $500K lawsuit without coverage. This is devastating.', 'Twitter', '2024-01-10 19:45:00'),
...
(5, 'Insurance_Broker', 'Frustrated with the current D&O market. Underwriters are asking for ridiculous amounts of information and still declining good risks. Clients are suffering. Something needs to change!', 'LinkedIn', '2024-01-11 21:00:00'),
(6, 'Board_Member', 'Grateful for our D&O coverage today. Shareholder lawsuit filed but our carrier assigned excellent defense counsel within 48 hours. Worth every penny of the premium. #BoardService #D&O', 'LinkedIn', '2024-01-12 16:45:00'),
...
(8, 'Legal_Tech', 'Interesting case law development on D&O Side A coverage. Delaware Court ruling could impact how we think about insured vs. insured exclusions. Insurance nerds unite! #InsuranceLaw #D&O', 'LinkedIn', '2024-01-13 22:15:00'),
...
(10, 'SMB_Owner', 'Finally got proper insurance coverage for my consulting business. E&O policy gives me peace of mind when signing big contracts. Highly recommend all consultants get this! #SmallBusiness #Consulting', 'LinkedIn', '2024-01-14 17:30:00');
...
(2, 'Premium Invoice INV-DO-2024-1567 dated February 1, 2024. Insured: Global Manufacturing Corp. Policy: Directors & Officers Liability DO-2024-GM-789. Coverage Amount: $15,000,000. Annual Premium: $125,500.00. Payment Terms: Net 30 days. Due Date: March 3, 2024. Account Manager: Robert Kim, ext. 4455.',
 'premium_invoice'),
(3, 'Underwriting Meeting scheduled for February 15, 2024 at 10:00 AM EST. Attendees: Chief Underwriter Margaret Foster, Senior Underwriter David Chen, Actuarial Lead Lisa Martinez. Subject: Large account review - E&O policy for Software Solutions Inc. Revenue $50M, requesting $10M limits. Conference Room: Executive Suite A, 15th Floor.',
 'meeting_notice'),
(4, 'Policy Quote QT-EPL-2024-8899 for Employment Practices Liability. Prospect: MedTech Innovations LLC. Employees: 450. Coverage Requested: $5M per claim, $5M aggregate. Premium Indication: $67,500 annually. Retention: $100,000. Quote valid until March 31, 2024. Underwriter: James Wilson. Territory: Multi-state (CA, TX, NY, FL).',
 'quote_document'),
(5, 'Loss Run Request for TechCorp International. Policy Period: 2019-2024. Insurance Type: D&O, E&O, Cyber, EPLI. Total Claims: 8. Paid Losses: $2.3M. Outstanding Reserves: $1.8M. Incidents: 3 D&O claims (securities litigation), 2 E&O claims (contract disputes), 2 Cyber incidents (data breaches), 1 EPLI claim (wrongful termination). Requested by: Broker Smith & Associates for renewal underwriting.',
 'loss_run');
